...
const AddAgency = () => {
  ...
  const AddNewAgency = async () => {
    try {
      ...
      } else if (AgentImages?.agencySmallLogo === null) {
      ...
      } else if (AgentImages?.commercialAgencySmallLogo === null) {
        toast.error("Please upload Commercial Agency Small Logo");
      } else if (AgentImages?.commercialAgencyMediumLogo === null) {
        toast.error("Please upload Commercial Agency Medium Logo");
      } else if (AgentImages?.commercialAgencyLargeLogo === null) {
        toast.error("Please upload Commercial Agency Large Logo");
      } else if (AgentImages?.commercialAgencyExtraLargeLogo === null) {
        toast.error("Please upload Commercial Agency Extra Large Logo");
