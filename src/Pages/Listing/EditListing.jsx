...
const EditListing = () => {
      ...
      .then((res) => {
        ...
        if (res?.data?.status) {
          ...
          setListingCheckboxs({
            ...
            outdoor_deck: mydata?.outdoor_deck,
            outdoor_swimming_pool_in_ground:
              mydata?.outdoor_swimming_pool_in_ground,
            outdoor_swimming_pool_above_ground:
              mydata?.outdoor_swimming_pool_above_ground,
            outdoor_tennis_court: mydata?.outdoor_tennis_court,
            outdoor_fully_fenced: mydata?.outdoor_fully_fenced,
            outdoor_shed: mydata?.outdoor_shed,
            outdoor_outside_spa: mydata?.outdoor_outside_spa,
            outdoor_outdoor_entertainment_area:
              mydata?.outdoor_outdoor_entertainment_area,
            outdoor_secure_parking: mydata?.outdoor_secure_parking,
            outdoor_courtyard: mydata?.outdoor_courtyard,
            outdoor_remote_garage: mydata?.outdoor_remote_garage,
            outdoor_garage: mydata?.outdoor_garage,
            outdoor_balcony: mydata?.outdoor_balcony,
            indoor_alaram_system: mydata?.indoor_alaram_system,
            indoor_study: mydata?.indoor_study,
            indoor_workshop: mydata?.indoor_workshop,
            indoor_gym: mydata?.indoor_gym,
            indoor_built_in_wardrodes: mydata?.indoor_built_in_wardrodes,
            indoor_intercom: mydata?.indoor_intercom,
            indoor_ducted_vacuum_system: mydata?.indoor_ducted_vacuum_system,
            indoor_rumpus_room: mydata?.indoor_rumpus_room,
            indoor_inside_spa: mydata?.indoor_inside_spa,
            indoor_floorboards: mydata?.indoor_floorboards,
            indoor_dishwashera: mydata?.indoor_dishwashera,
            indoor_play_tv_access: mydata?.indoor_play_tv_access,
            indoor_broadband_internet_available:
              mydata?.indoor_broadband_internet_available,
            hc_air_conditioning: mydata?.hc_air_conditioning,
            hc_ducted_heating: mydata?.hc_ducted_heating,
            hc_hydronic_heating: mydata?.hc_hydronic_heating,
            hc_ducted_cooling: mydata?.hc_ducted_cooling,
            hc_gas_heating: mydata?.hc_gas_heating,
            hc_open_fireplace: mydata?.hc_open_fireplace,
            hc_split_system_air_conditioning:
              mydata?.hc_split_system_air_conditioning,
            hc_split_system_heating: mydata?.hc_split_system_heating,
            hc_evaporative_cooling: mydata?.hc_evaporative_cooling,
            hc_reverse_cycle_air_conditioning:
              mydata?.hc_reverse_cycle_air_conditioning,
            eff_solar_hot_water: mydata?.eff_solar_hot_water,
            eff_water_tank: mydata?.eff_water_tank,
            eff_grey_water_system: mydata?.eff_grey_water_system,
            eff_solar_panels: mydata?.eff_solar_panels,
            cces_air_conditionings: mydata?.cces_air_conditionings,
            cces_solar_hot_water: mydata?.cces_solar_hot_water,
            cces_high_energy_efficieny: mydata?.cces_high_energy_efficieny,
            cces_solar_panels: mydata?.cces_solar_panels,
            cces_heating: mydata?.cces_heating,
            cces_water_tank: mydata?.cces_water_tank,
          });
          // setListingImages({
          //   ...ListingImages,
          //   propertyImg: mydata?.propertyImg,
          //   florePlansImg: mydata?.florePlansImg,
          //   frontPageImg: mydata?.frontPageImg,
          //   statementOfInfo: mydata?.statementOfInfo,
          // });
  ...
  const [ListingCheckboxs, setListingCheckboxs] = useState({
    ...
    outdoor_deck: true,
    outdoor_swimming_pool_in_ground: false,
    outdoor_swimming_pool_above_ground: false,
    outdoor_tennis_court: false,
    outdoor_fully_fenced: false,
    outdoor_shed: false,
    outdoor_outside_spa: false,
    outdoor_outdoor_entertainment_area: false,
    outdoor_secure_parking: true,
    outdoor_courtyard: false,
    outdoor_remote_garage: false,
    outdoor_garage: true,
    outdoor_balcony: false,

    indoor_alaram_system: false,
    indoor_study: true,
    indoor_workshop: false,
    indoor_gym: false,
    indoor_built_in_wardrodes: true,
    indoor_intercom: false,
    indoor_ducted_vacuum_system: false,
    indoor_rumpus_room: false,
    indoor_inside_spa: false,
    indoor_floorboards: false,
    indoor_dishwashera: false,
    indoor_play_tv_access: false,
    indoor_broadband_internet_available: false,

    hc_air_conditioning: false,
    hc_ducted_heating: true,
    hc_hydronic_heating: false,
    hc_ducted_cooling: false,
    hc_gas_heating: true,
    hc_open_fireplace: false,
    hc_split_system_air_conditioning: false,
    hc_split_system_heating: false,
    hc_evaporative_cooling: false,
    hc_reverse_cycle_air_conditioning: false,

    eff_solar_hot_water: true,
    eff_water_tank: false,
    eff_grey_water_system: false,
    eff_solar_panels: true,

    cces_air_conditionings: true,
    cces_solar_hot_water: false,
    cces_high_energy_efficieny: false,
    cces_solar_panels: true,
    cces_heating: false,
    cces_water_tank: false,
  ...
  const handelFinalSubmit = async () => {
    try {
      ...
      formData.append("agency_id", ListingDetails?.agency_id);
      formData.append("status", ListingDetails?.status);
      formData.append("property_type", ListingDetails?.property_type);
      formData.append(
        "new_or_established_checked",
        ListingDetails?.new_or_established_checked
      );
      formData.append("lead_agent", ListingDetails?.lead_agent);
      formData.append("authority", ListingDetails?.authority);
      formData.append("price", ListingDetails?.price);
      formData.append("price_display", ListingDetails?.price_display);
      formData.append(
        "price_display_checked",
        ListingDetails?.price_display_checked
      );
      formData.append("name", ListingDetails?.name);
      formData.append("email", ListingDetails?.email);
      formData.append("phone_number", ListingDetails?.phone_number);
      formData.append("unit", ListingDetails?.unit);
      formData.append(
        "street_address_number",
      ...
      formData.append("suburb", ListingDetails?.suburb);
      formData.append("municipality", ListingDetails?.municipality);
      formData.append("auction_result", ListingDetails?.auction_result);
      formData.append("maximum_bid", ListingDetails?.maximum_bid);
      formData.append("Bedrooms", ListingDetails?.Bedrooms);
      formData.append("Bathrooms", ListingDetails?.Bathrooms);
      formData.append("Ensuites", ListingDetails?.Ensuites);
      formData.append("toilets", ListingDetails?.toilets);
      formData.append("garage_spaces", ListingDetails?.garage_spaces);
      formData.append("carport_spaces", ListingDetails?.carport_spaces);
      formData.append("open_spaces", ListingDetails?.open_spaces);
      formData.append(
        "energy_efficiensy_rating",
        ListingDetails?.energy_efficiensy_rating
      );
      formData.append("living_areas", ListingDetails?.living_areas);
      formData.append("house_size", ListingDetails?.house_size);
      formData.append("house_size_square", ListingDetails?.house_size_square);
      formData.append("land_size", ListingDetails?.land_size);
      formData.append("land_size_square", ListingDetails?.land_size_square);
      formData.append("other_features", ListingDetails?.other_features);
      formData.append("heading", ListingDetails?.heading);
      formData.append("discription", ListingDetails?.discription);
      formData.append("video_url", ListingDetails?.video_url);
      formData.append("online_tour_1", ListingDetails?.online_tour_1);
      formData.append("online_tour_2", ListingDetails?.online_tour_2);
      formData.append("agency_listing_url", ListingDetails?.job_title);
      ...
      formData.append("outdoor_deck", ListingCheckboxs?.outdoor_deck);
      formData.append(
        "outdoor_swimming_pool_in_ground",
        ListingCheckboxs?.outdoor_swimming_pool_in_ground
      );
      formData.append(
        "outdoor_swimming_pool_above_ground",
        ListingCheckboxs?.outdoor_swimming_pool_above_ground
      );
      formData.append(
        "outdoor_tennis_court",
        ListingCheckboxs?.outdoor_tennis_court
      );
      formData.append(
        "outdoor_fully_fenced",
        ListingCheckboxs?.outdoor_fully_fenced
      );
      formData.append("outdoor_shed", ListingCheckboxs?.outdoor_shed);
      formData.append(
        "outdoor_outside_spa",
        ListingCheckboxs?.outdoor_outside_spa
      );
      formData.append(
        "outdoor_outdoor_entertainment_area",
        ListingCheckboxs?.outdoor_outdoor_entertainment_area
      );
      formData.append(
        "outdoor_secure_parking",
        ListingCheckboxs?.outdoor_secure_parking
      );
      formData.append("outdoor_courtyard", ListingCheckboxs?.outdoor_courtyard);
      formData.append(
        "outdoor_remote_garage",
        ListingCheckboxs?.outdoor_remote_garage
      );
      formData.append("outdoor_garage", ListingCheckboxs?.outdoor_garage);
      formData.append("outdoor_balcony", ListingCheckboxs?.outdoor_balcony);
      formData.append(
        "indoor_alaram_system",
        ListingCheckboxs?.indoor_alaram_system
      );
      formData.append("indoor_study", ListingCheckboxs?.indoor_study);
      formData.append("indoor_workshop", ListingCheckboxs?.indoor_workshop);
      formData.append("indoor_gym", ListingCheckboxs?.indoor_gym);
      formData.append(
        "indoor_built_in_wardrodes",
        ListingCheckboxs?.indoor_built_in_wardrodes
      );
      formData.append("indoor_intercom", ListingCheckboxs?.indoor_intercom);
      formData.append(
        "indoor_ducted_vacuum_system",
        ListingCheckboxs?.indoor_ducted_vacuum_system
      );
      formData.append(
        "indoor_rumpus_room",
        ListingCheckboxs?.indoor_rumpus_room
      );
      formData.append("indoor_inside_spa", ListingCheckboxs?.indoor_inside_spa);
      formData.append(
        "indoor_floorboards",
        ListingCheckboxs?.indoor_floorboards
      );
      formData.append(
        "indoor_dishwashera",
        ListingCheckboxs?.indoor_dishwashera
      );
      formData.append(
        "indoor_play_tv_access",
        ListingCheckboxs?.indoor_play_tv_access
      );
      formData.append(
        "indoor_broadband_internet_available",
        ListingCheckboxs?.indoor_broadband_internet_available
      );
      formData.append(
        "hc_air_conditioning",
        ListingCheckboxs?.hc_air_conditioning
      );
      formData.append("hc_ducted_heating", ListingCheckboxs?.hc_ducted_heating);
      formData.append(
        "hc_hydronic_heating",
        ListingCheckboxs?.hc_hydronic_heating
      );
      formData.append("hc_ducted_cooling", ListingCheckboxs?.hc_ducted_cooling);
      formData.append("hc_gas_heating", ListingCheckboxs?.hc_gas_heating);
      formData.append("hc_open_fireplace", ListingCheckboxs?.hc_open_fireplace);
      formData.append(
        "hc_split_system_air_conditioning",
        ListingCheckboxs?.hc_split_system_air_conditioning
      );
      formData.append(
        "hc_split_system_heating",
        ListingCheckboxs?.hc_split_system_heating
      );
      formData.append(
        "hc_evaporative_cooling",
        ListingCheckboxs?.hc_evaporative_cooling
      );
      formData.append(
        "hc_reverse_cycle_air_conditioning",
        ListingCheckboxs?.hc_reverse_cycle_air_conditioning
      );
      formData.append(
        "eff_solar_hot_water",
        ListingCheckboxs?.eff_solar_hot_water
      );
      formData.append("eff_water_tank", ListingCheckboxs?.eff_water_tank);
      formData.append(
        "eff_grey_water_system",
        ListingCheckboxs?.eff_grey_water_system
      );
      formData.append("eff_solar_panels", ListingCheckboxs?.eff_solar_panels);
      formData.append(
        "cces_air_conditionings",
        ListingCheckboxs?.cces_air_conditionings
      );
      formData.append(
        "cces_solar_hot_water",
        ListingCheckboxs?.cces_solar_hot_water
      );
      formData.append(
        "cces_high_energy_efficieny",
        ListingCheckboxs?.cces_high_energy_efficieny
      );
      formData.append("cces_solar_panels", ListingCheckboxs?.cces_solar_panels);
      formData.append("cces_heating", ListingCheckboxs?.cces_heating);
      formData.append("cces_water_tank", ListingCheckboxs?.cces_water_tank);
                      ...
                      OutdoorFeatures?.map((d, index) => (
                        <div
                          ...
                          onClick={() => {
                            setListingCheckboxs({
                              ...ListingCheckboxs,
                              [d?.name]: !ListingCheckboxs?.[d?.name],
                            });
                          }}
                        >
                          {d?.title}
                          {ListingCheckboxs?.[d?.name] === true && (
                            <div className="grid place-content-center rounded-2xl">
                              <input
                                type="checkbox"
                                name={d?.name}
                                defaultChecked={ListingCheckboxs?.[d?.name]}
                                className="w-3 h-3 accent-[#E5002A] cursor-pointer"
                              />
                            </div>
                          )}
                ...
                >
                  ...
                  >
                    ...
                    <div className="w-auto md:w-[50%] flex flex-row flex-wrap justify-center items-center gap-2 font-semibold text-center text-xs md:text-base lg:text-lg text-[#171717]">
                      Deop a front page image in this area
                    ...
                    <div className="w-full text-[#404040] font-medium text-xs md:text-sm my-2 lg:my-4">
                      ...
                      <div className="w-full flex flex-row justify-start gap-2">
                        <select
                          ...
                          className="w-full font-medium !text-[#737373] text-xs md:text-sm  outline-none border border-[#E5E5E5] rounded-3xl p-3 mt-2 cursor-pointer"
                        >
                          <option value="" hidden>
                            Hr
                          </option>
